...
<template>
  <Tab
    ><div class="tabs_content Oli">
      <ul class="subNavbar">
        <li @click="FunChooseTabName('oli')" class="active">Who is Oli</li>
        <li @click="FunChooseTabName('story')">Story</li>
        <li @click="FunChooseTabName('Journey')">Journey</li>
      </ul>
      <div class="content">
        <span>Who is Oli</span>
        <h1>always by <span>your side</span></h1>
        <p>
...
@import "./Styling.scss";
.Oli {
  background: url("../../../../assets/images/Oli.jpg") center center;
  .content {
    margin-left: auto;
    margin-right: 5%;
    padding-top: 8%;
